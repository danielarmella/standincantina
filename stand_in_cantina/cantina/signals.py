...
#     avail = Availability.objects.get(stand_in=instance.stand_in, booked=instance)
...
def make_standin_available(sender, instance, **kwargs):
    availability = Availability.objects.create(stand_in=instance.stand_in, start_date=instance.start_date, end_date=instance.end_date, is_available=True, booked=None, notes=f"Booking for {instance.project} canceled. Stand-in released and is showing available.")
    print(availability)
...
#             to=instance.stand_in.user.phone,  # Assuming a phone number field exists
#             from_="+12159177265",
#             body=message
#         )
